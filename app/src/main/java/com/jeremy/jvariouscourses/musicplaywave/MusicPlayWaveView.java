...
public class MusicPlayWaveView extends View {
    ...
    //指针的颜色
    private int mDefaultPointerColor = Color.parseColor("#5CB964");
    ...
    public MusicPlayWaveView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public MusicPlayWaveView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.MusicPlayWaveView);
        mDefaultPointerColor = ta.getColor(R.styleable.MusicPlayWaveView_pointer_color, mDefaultPointerColor);
        pointerNum = ta.getInt(R.styleable.MusicPlayWaveView_pointer_num, 6);
        pointerWidth = dp2px(ta.getFloat(R.styleable.MusicPlayWaveView_pointer_width, 2));
        pointerSpeed = ta.getInt(R.styleable.MusicPlayWaveView_pointer_speed, 40);
        ta.recycle();
        init();
    }
    ...
    private void init() {
        ...
        paint.setColor(mDefaultPointerColor);
